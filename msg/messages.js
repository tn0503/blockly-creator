...
/** @type {string} */
/// button text - Text on the button used to launch the variable creation dialogue.
Blockly.Msg.NEW_BOOLEAN_VARIABLE = 'Create boolean variable...';
/** @type {string} */
/// button text - Text on the button used to launch the variable creation dialogue.
Blockly.Msg.NEW_SNUMBER_VARIABLE = 'Create short number variable...';
/** @type {string} */
/// button text - Text on the button used to launch the variable creation dialogue.
Blockly.Msg.NEW_NUMBER_VARIABLE = 'Create number variable...';
/** @type {string} */
/// button text - Text on the button used to launch the variable creation dialogue.
Blockly.Msg.NEW_FLOAT_VARIABLE = 'Create float variable...';
/** @type {string} */
/// button text - Text on the button used to launch the variable creation dialogue.
Blockly.Msg.NEW_ARRAY_VARIABLE = 'Create array variable...';
/** @type {string} */
...
// Arduino Blocks.
Blockly.Msg.ARDUINO_GENERAL_MSG_SETUP = 'setup';
Blockly.Msg.ARDUINO_GENERAL_MSG_LOOP = 'loop';
Blockly.Msg.ARDUINO_GENERAL_MSG_COMMENT = 'comment';
Blockly.Msg.ARDUINO_INOUT_MSG_DWITE = 'DigitalWrite PIN#';
Blockly.Msg.ARDUINO_INOUT_MSG_STATE = 'State';
Blockly.Msg.ARDUINO_INOUT_MSG_DREAD = 'DigitalRead PIN#';
Blockly.Msg.ARDUINO_INOUT_MSG_AWITE = 'AnalogWrite PIN#';
Blockly.Msg.ARDUINO_INOUT_MSG_VALUE = 'value';
Blockly.Msg.ARDUINO_INOUT_MSG_AREAD = 'AnalogRead PIN#';
Blockly.Msg.ARDUINO_INOUT_MSG_TONE = 'Tone PIN#';
Blockly.Msg.ARDUINO_INOUT_MSG_FREQ = 'frequency';
Blockly.Msg.ARDUINO_INOUT_MSG_DURA = 'duration';
Blockly.Msg.ARDUINO_INOUT_MSG_NOTONE = 'NoTone PIN#';
Blockly.Msg.ARDUINO_OTHERS_MSG_DELAY = 'Delay';
Blockly.Msg.ARDUINO_OTHERS_MSG_END = 'Terminate';
Blockly.Msg.ARDUINO_OTHERS_MSG_RAND = 'Random from';
Blockly.Msg.ARDUINO_OTHERS_MSG_TO = 'to';
Blockly.Msg.ARDUINO_OTHERS_MSG_RSEED = 'Random seed';
Blockly.Msg.ARDUINO_OTHERS_MSG_SERIAL = 'Serial Print';
Blockly.Msg.ARDUINO_OTHERS_MSG_SERVO = 'Servo PIN#';
Blockly.Msg.ARDUINO_OTHERS_MSG_ANGLE = 'angle';

// MYGAME Blocks
Blockly.Msg.MYGAME_GENERAL_MSG_BEGIN = 'Initialize game';
Blockly.Msg.MYGAME_GENERAL_MSG_SWIDTH = 'scr width';
Blockly.Msg.MYGAME_GENERAL_MSG_SHEIGHT = 'scr height';
Blockly.Msg.MYGAME_GENERAL_MSG_CLEAR = 'Clear screen';
Blockly.Msg.MYGAME_GENERAL_MSG_FLASH = 'Refresh screen';
Blockly.Msg.MYGAME_GENERAL_MSG_UPDATE = 'Update';
Blockly.Msg.MYGAME_GENERAL_MSG_MS = 'ms';

Blockly.Msg.MYGAME_DRAW_MSG_PIXEL = 'Draw pixel';
Blockly.Msg.MYGAME_DRAW_MSG_LINE = 'Draw line';
Blockly.Msg.MYGAME_DRAW_MSG_VLINE = 'Draw fast v-line';
Blockly.Msg.MYGAME_DRAW_MSG_HLINE = 'Draw fast h-line';
Blockly.Msg.MYGAME_DRAW_MSG_RECT = 'Draw rectangle';
Blockly.Msg.MYGAME_DRAW_MSG_FRECT = 'Fill rectangle';
Blockly.Msg.MYGAME_DRAW_MSG_CIRCLE = 'Draw circle';
Blockly.Msg.MYGAME_DRAW_MSG_FCIRCLE = 'Fill circle';
Blockly.Msg.MYGAME_DRAW_MSG_RRECT = 'Draw round rectangle';
Blockly.Msg.MYGAME_DRAW_MSG_FRRECT = 'Fill round rectangle';
Blockly.Msg.MYGAME_DRAW_MSG_ELLIPSE = 'Draw ellipse';
Blockly.Msg.MYGAME_DRAW_MSG_FELLIPSE = 'Fill ellipse';
Blockly.Msg.MYGAME_DRAW_MSG_DRAWBMP = 'Draw bitmap';
Blockly.Msg.MYGAME_DRAW_MSG_CBMP = 'Create bitmap';
Blockly.Msg.MYGAME_DRAW_MSG_DRAWSTRING = 'Draw string';
Blockly.Msg.MYGAME_DRAW_MSG_DRAWCHAR = 'Draw char';
Blockly.Msg.MYGAME_DRAW_MSG_DRAWNUM = 'Draw num';
Blockly.Msg.MYGAME_BTN_MSG_BTN = 'Button';
Blockly.Msg.MYGAME_ARRAY_MSG_CARRAY = 'Create array';
Blockly.Msg.MYGAME_ARRAY_MSG_SET = 'Set';
Blockly.Msg.MYGAME_ARRAY_MSG_GET = 'Get';

Blockly.Msg.MYGAME_DRAW_MSG_X = 'X';
Blockly.Msg.MYGAME_DRAW_MSG_Y = 'Y';
Blockly.Msg.MYGAME_DRAW_MSG_X0 = 'X0';
Blockly.Msg.MYGAME_DRAW_MSG_Y0 = 'Y0';
Blockly.Msg.MYGAME_DRAW_MSG_X1 = 'X1';
Blockly.Msg.MYGAME_DRAW_MSG_Y1 = 'Y1';
Blockly.Msg.MYGAME_DRAW_MSG_LENGTH = 'L';
Blockly.Msg.MYGAME_DRAW_MSG_WIDTH = 'W';
Blockly.Msg.MYGAME_DRAW_MSG_HEIGHT = 'H';
Blockly.Msg.MYGAME_DRAW_MSG_RAD = 'R';
Blockly.Msg.MYGAME_DRAW_MSG_XAXIS = 'xAxis';
Blockly.Msg.MYGAME_DRAW_MSG_YAXIS = 'yAxis';
Blockly.Msg.MYGAME_DRAW_MSG_XWIDTH = '*W';
Blockly.Msg.MYGAME_DRAW_MSG_XHEIGHT = '*H';
Blockly.Msg.MYGAME_DRAW_MSG_BMP = 'bmp';
Blockly.Msg.MYGAME_DRAW_MSG_STRING = 'string';
Blockly.Msg.MYGAME_DRAW_MSG_SIZE = 'size';
Blockly.Msg.MYGAME_DRAW_MSG_CHAR = 'char';
Blockly.Msg.MYGAME_DRAW_MSG_NUM = 'num';
Blockly.Msg.MYGAME_BTN_MSG_STATE = 'state';
Blockly.Msg.MYGAME_BTN_MSG_PRESSED = 'pressed';
Blockly.Msg.MYGAME_ARRAY_MSG_ROW = 'row';
Blockly.Msg.MYGAME_ARRAY_MSG_COL = 'col';
Blockly.Msg.MYGAME_ARRAY_MSG_ARRAY = 'array';
Blockly.Msg.MYGAME_ARRAY_MSG_VALUE = 'value';
Blockly.Msg.MYGAME_ARRAY_MSG_TYPE = 'type';

Blockly.Msg.MYGAME_DRAW_MSG_WB = 'w/b';
