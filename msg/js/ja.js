...
Blockly.Msg["ARDUINO_GENERAL_MSG_COMMENT"] = "コメント";
Blockly.Msg["ARDUINO_GENERAL_MSG_LOOP"] = "ループ";
Blockly.Msg["ARDUINO_GENERAL_MSG_SETUP"] = "初期設定";
Blockly.Msg["ARDUINO_INOUT_MSG_AREAD"] = "アナログ入力 ピン#";
Blockly.Msg["ARDUINO_INOUT_MSG_AWITE"] = "アナログ出力 ピン#";
Blockly.Msg["ARDUINO_INOUT_MSG_DREAD"] = "デジタル入力 ピン#";
Blockly.Msg["ARDUINO_INOUT_MSG_DURA"] = "長さ";
Blockly.Msg["ARDUINO_INOUT_MSG_DWITE"] = "デジタル出力 ピン#";
Blockly.Msg["ARDUINO_INOUT_MSG_FREQ"] = "周波数";
Blockly.Msg["ARDUINO_INOUT_MSG_NOTONE"] = "サウンド停止 ピン#";
Blockly.Msg["ARDUINO_INOUT_MSG_STATE"] = "状態";
Blockly.Msg["ARDUINO_INOUT_MSG_TONE"] = "サウンド ピン#";
Blockly.Msg["ARDUINO_INOUT_MSG_VALUE"] = "値";
Blockly.Msg["ARDUINO_OTHERS_MSG_ANGLE"] = "角度";
Blockly.Msg["ARDUINO_OTHERS_MSG_DELAY"] = "待つ";
Blockly.Msg["ARDUINO_OTHERS_MSG_END"] = "プログラムを終了";
Blockly.Msg["ARDUINO_OTHERS_MSG_RAND"] = "乱数 範囲";
Blockly.Msg["ARDUINO_OTHERS_MSG_RSEED"] = "乱数初期化";
Blockly.Msg["ARDUINO_OTHERS_MSG_SERIAL"] = "シリアル出力";
Blockly.Msg["ARDUINO_OTHERS_MSG_SERVO"] = "サーボ ピン#";
Blockly.Msg["ARDUINO_OTHERS_MSG_TO"] = "から";
...
Blockly.Msg["MYGAME_ARRAY_MSG_ARRAY"] = "配列";
Blockly.Msg["MYGAME_ARRAY_MSG_CARRAY"] = "配列を作成";
Blockly.Msg["MYGAME_ARRAY_MSG_COL"] = "列";
Blockly.Msg["MYGAME_ARRAY_MSG_GET"] = "要素を得る";
Blockly.Msg["MYGAME_ARRAY_MSG_ROW"] = "行";
Blockly.Msg["MYGAME_ARRAY_MSG_SET"] = "要素をセット";
Blockly.Msg["MYGAME_ARRAY_MSG_TYPE"] = "型";
Blockly.Msg["MYGAME_ARRAY_MSG_VALUE"] = "値";
Blockly.Msg["MYGAME_BTN_MSG_BTN"] = "ボタン";
Blockly.Msg["MYGAME_BTN_MSG_PRESSED"] = "押された";
Blockly.Msg["MYGAME_BTN_MSG_STATE"] = "状態";
Blockly.Msg["MYGAME_DRAW_MSG_BMP"] = "ビットマップ";
Blockly.Msg["MYGAME_DRAW_MSG_CBMP"] = "ビットマップを作成";
Blockly.Msg["MYGAME_DRAW_MSG_CHAR"] = "文字";
Blockly.Msg["MYGAME_DRAW_MSG_CIRCLE"] = "円を描画";
Blockly.Msg["MYGAME_DRAW_MSG_DRAWBMP"] = "ビットマップを描画";
Blockly.Msg["MYGAME_DRAW_MSG_DRAWCHAR"] = "文字を描画";
Blockly.Msg["MYGAME_DRAW_MSG_DRAWNUM"] = "数値を描画";
Blockly.Msg["MYGAME_DRAW_MSG_DRAWSTRING"] = "文字列を描画";
Blockly.Msg["MYGAME_DRAW_MSG_ELLIPSE"] = "楕円を描画";
Blockly.Msg["MYGAME_DRAW_MSG_FCIRCLE"] = "円を塗り潰し";
Blockly.Msg["MYGAME_DRAW_MSG_FELLIPSE"] = "楕円を塗り潰し";
Blockly.Msg["MYGAME_DRAW_MSG_FRECT"] = "長方形を塗り潰し";
Blockly.Msg["MYGAME_DRAW_MSG_FRRECT"] = "角丸長方形を塗り潰し";
Blockly.Msg["MYGAME_DRAW_MSG_HEIGHT"] = "高さ";
Blockly.Msg["MYGAME_DRAW_MSG_HLINE"] = "横線を高速描画";
Blockly.Msg["MYGAME_DRAW_MSG_LENGTH"] = "長さ";
Blockly.Msg["MYGAME_DRAW_MSG_LINE"] = "直線を描画";
Blockly.Msg["MYGAME_DRAW_MSG_NUM"] = "数値";
Blockly.Msg["MYGAME_DRAW_MSG_PIXEL"] = "点を描画";
Blockly.Msg["MYGAME_DRAW_MSG_RAD"] = "半径";
Blockly.Msg["MYGAME_DRAW_MSG_RECT"] = "長方形を描画";
Blockly.Msg["MYGAME_DRAW_MSG_RRECT"] = "角丸長方形を描画";
Blockly.Msg["MYGAME_DRAW_MSG_SIZE"] = "サイズ";
Blockly.Msg["MYGAME_DRAW_MSG_STRING"] = "文字列";
Blockly.Msg["MYGAME_DRAW_MSG_VLINE"] = "縦線を高速描画";
Blockly.Msg["MYGAME_DRAW_MSG_WB"] = "w/b";
Blockly.Msg["MYGAME_DRAW_MSG_WIDTH"] = "幅";
Blockly.Msg["MYGAME_DRAW_MSG_X"] = "X";
Blockly.Msg["MYGAME_DRAW_MSG_X0"] = "X0";
Blockly.Msg["MYGAME_DRAW_MSG_X1"] = "X1";
Blockly.Msg["MYGAME_DRAW_MSG_XAXIS"] = "x軸";
Blockly.Msg["MYGAME_DRAW_MSG_XHEIGHT"] = "*高さ";
Blockly.Msg["MYGAME_DRAW_MSG_XWIDTH"] = "*幅";
Blockly.Msg["MYGAME_DRAW_MSG_Y"] = "Y";
Blockly.Msg["MYGAME_DRAW_MSG_Y0"] = "Y0";
Blockly.Msg["MYGAME_DRAW_MSG_Y1"] = "Y1";
Blockly.Msg["MYGAME_DRAW_MSG_YAXIS"] = "y軸";
Blockly.Msg["MYGAME_GENERAL_MSG_BEGIN"] = "ゲーム初期化";
Blockly.Msg["MYGAME_GENERAL_MSG_CLEAR"] = "画面クリア";
Blockly.Msg["MYGAME_GENERAL_MSG_FLASH"] = "画面描画";
Blockly.Msg["MYGAME_GENERAL_MSG_MS"] = "ms";
Blockly.Msg["MYGAME_GENERAL_MSG_SHEIGHT"] = "画面高さ";
Blockly.Msg["MYGAME_GENERAL_MSG_SWIDTH"] = "画面幅";
Blockly.Msg["MYGAME_GENERAL_MSG_UPDATE"] = "アップデート";
Blockly.Msg["NEW_ARRAY_VARIABLE"] = "配列の変数を作る...";
Blockly.Msg["NEW_BOOLEAN_VARIABLE"] = "真偽値の変数を作る...";
Blockly.Msg["NEW_FLOAT_VARIABLE"] = "小数の変数を作る...";
Blockly.Msg["NEW_NUMBER_VARIABLE"] = "整数(16bit)の変数を作る...";
Blockly.Msg["NEW_SNUMBER_VARIABLE"] = "整数(8bit)の変数を作る...";
